...
func (r *ExternalReconciler) ReconcileServiceAccountSecret(ctx context.Context, hcp *tenancyv1alpha1.ControlPlane) error {
...
func (r *ExternalReconciler) ReconcileKubeconfigSecret(ctx context.Context, hcp *tenancyv1alpha1.ControlPlane) error {
	_ = clog.FromContext(ctx)
	namespace := util.GenerateNamespaceFromControlPlaneName(hcp.Name)
...
func (r *ExternalReconciler) getServiceAccountToken(ctx context.Context, hcp *tenancyv1alpha1.ControlPlane) ([]byte, []byte, error) {
	namespace := util.GenerateNamespaceFromControlPlaneName(hcp.Name)
