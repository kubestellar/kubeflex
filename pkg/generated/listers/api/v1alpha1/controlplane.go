...
func NewControlPlaneLister(indexer cache.Indexer) ControlPlaneLister {
	return &controlPlaneLister{listers.New[*apiv1alpha1.ControlPlane](indexer, apiv1alpha1.Resource("controlplane"))}
}
